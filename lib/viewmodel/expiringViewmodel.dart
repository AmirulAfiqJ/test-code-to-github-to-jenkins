...
class ExpiringViewmodel extends ChangeNotifier {
  ...
  final List<String> feedbackItems = ['Select Feedback','Irrelevant, Renewed','Bad experience','Bad support','Change business model','Stop business',
                                      'Fifty-fifty','Unknown reason','Use another BIZAPP ID','Other'
  ];
